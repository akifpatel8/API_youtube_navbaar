...
async function defaultVideos(){
    ...
    let res=await fetch(`https://youtube.googleapis.com/youtube/v3/search?q=most_popular_videos_in_india&key=AIzaSyCqqEL64PvDYgjKhg7PkiDl-4MM2W4sLL0&maxResults=21`);
